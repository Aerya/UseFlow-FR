...
const translations = {
  fr: {
    ...
    config_rss_force_films: "Films uniquement",
    config_rss_force_series: "Séries uniquement",
    config_rss_force_docs: "Documentaires uniquement",
  ...
  en: {
    ...
    config_rss_force_auto: "Auto",
    config_rss_force_films: "Movies only",
    config_rss_force_series: "Series only",
    config_rss_force_docs: "Documentaries only",
  ...
  de: {
    ...
    config_rss_force_auto: "Auto",
    config_rss_force_films: "Nur Filme",
    config_rss_force_series: "Nur Serien",
    config_rss_force_docs: "Nur Dokumentarfilme",
